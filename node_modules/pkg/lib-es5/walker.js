...
var Walker = function () {
  ...
  (0, _createClass3.default)(Walker, [{
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 16:
                ...
                if (record.marker.public || record.marker.hasDictionary) {
                  this.append({
                    file: record.file,
                    marker: record.marker,
                    store: _common.STORE_CONTENT
    ...
    key: 'start',
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(marker, entrypoint, addition, params) {
        var tasks, i;
      ...
      function start(_x15, _x16, _x17, _x18) {
